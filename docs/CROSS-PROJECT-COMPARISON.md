...
>
> **🎉 更新 2026-06-17：主要差距已全部对齐。** 见文末"七、对齐结果汇总"。
> - 函数表：433 catalog names（> kqlparser 425）— §2.3 缺口闭合
> - `like`/`like_cs` emit：全后端支持 — §2.2 缺口闭合
> - Sigma 真实狩猎规则 fuzz：85/85 (100%) parse+translate — §3.1 落地
